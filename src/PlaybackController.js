/* -------------------------------------------
   ...
   export class PlaybackController {
    ...
    constructor(
      ...
      if (!this.button) {
        console.error(`PlaybackController Error: No element found for "${buttonSelector}"`);
        return;
      }
      ...
      if (groupName) {
        PlaybackController.registerButtonInGroup(groupName, this, forceOneActive);
    ...
    static registerButtonInGroup(groupName, buttonInstance, forceOneActive) {
      if (!PlaybackController.groups[groupName]) {
        PlaybackController.groups[groupName] = {
          buttons: [],
          forceOneActive
        };
      }
      PlaybackController.groups[groupName].buttons.push(buttonInstance);
    }
    ...
    toggleActive() {
      const groupInfo = PlaybackController.groups[this.groupName];
      if (!groupInfo) {
